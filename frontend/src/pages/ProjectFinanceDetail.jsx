...
const ProjectFinanceDetail = () => {
  ...
  // Use payment schedule directly from backend - backend now handles correct calculations
  // Backend uses: signoff_value (primary) → project_value (fallback)
  // Default stages: Booking (fixed) + 50% + Remaining balance
  const normalizedPaymentSchedule = paymentSchedule;
