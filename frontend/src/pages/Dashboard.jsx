...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (['Founder', 'SalesManager', 'DesignManager', 'ProductionOpsManager', 'FinanceManager', 'SeniorAccountant', 'JuniorAccountant', 'Accountant', 'CharteredAccountant'].includes(user?.role)) return;
    fetchDashboardData();
  }, [user]);
