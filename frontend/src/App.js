  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/projects/:id/spatial-boq" element={<SpatialBOQCanvas />} />
        ...
        <Route path="/finance/designer-dashboard" element={<DesignerDashboard />} />
        ...
        <Route path="/finance/daily-snapshot" element={<DailyClosingSnapshot />} />
