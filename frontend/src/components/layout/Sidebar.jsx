...
const financeSubItems = [
  ...
  { path: '/finance/sales-dashboard', label: 'Sales & Funnel', icon: Target },  // Full value lifecycle
  { path: '/finance/designer-dashboard', label: 'Designer Performance', icon: Palette },  // Designer metrics
  ...
  { path: '/finance/purchase-returns', label: 'Purchase Returns', icon: RotateCcw },
  { path: '/finance/sales-returns', label: 'Sales Returns', icon: Package },
  { path: '/finance/returned-items-register', label: 'Returns Register', icon: ClipboardList },
  { path: '/finance/credit-notes', label: 'Credit Notes', icon: FileMinus },
  { path: '/finance/debit-notes', label: 'Debit Notes', icon: FilePlus },
  { path: '/finance/replacement-orders', label: 'Replacements', icon: PackageCheck },
  ...
  { path: '/finance/daily-closing', label: 'Daybook', icon: CalendarCheck },
