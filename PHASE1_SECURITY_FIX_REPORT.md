...
### After (SECURE):
```
CORS_ORIGINS="https://arkiflo.arkidots.com,https://app.arkiflo.com,https://ledger-recovery.preview.emergentagent.com,http://localhost:3000"
```
...
| `https://ledger-recovery.preview.emergentagent.com` | Emergent preview |
