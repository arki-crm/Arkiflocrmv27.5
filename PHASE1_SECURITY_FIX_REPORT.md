...
### After (SECURE):
```
CORS_ORIGINS="https://arkiflo.arkidots.com,https://app.arkiflo.com,https://ceo-command-3.preview.emergentagent.com,http://localhost:3000"
```
...
| `https://ceo-command-3.preview.emergentagent.com` | Emergent preview |
