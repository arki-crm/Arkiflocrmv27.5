...
### After (SECURE):
```
CORS_ORIGINS="https://arkiflo.arkidots.com,https://app.arkiflo.com,https://double-entry-repair.preview.emergentagent.com,http://localhost:3000"
```
...
| `https://double-entry-repair.preview.emergentagent.com` | Emergent preview |
